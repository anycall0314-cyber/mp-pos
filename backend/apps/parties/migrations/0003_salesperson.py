...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('parties', '0002_alter_customer_options_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.SlugField(max_length=20, verbose_name='業務員代號')),
            ...
            options={
                ...
                'ordering': ['code'],
                'constraints': [models.UniqueConstraint(fields=('tenant', 'code'), name='uniq_salesperson_tenant_code')],
            },
        ),
    ]
